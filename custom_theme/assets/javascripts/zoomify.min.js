...
!(function (z) {
  (Zoomify = function (o, i) {
    var t = this;
    (this._zooming = !1),
      (this._zoomed = !1),
      (this._timeout = null),
      (this.$shadow = null),
      (this.$image = z(o).addClass('zoomify')),
      (this.options = z.extend({}, Zoomify.DEFAULTS, this.$image.data(), i)),
    ...
    (Zoomify.DEFAULTS = { duration: 200, easing: 'linear', scale: 0.9 }),
    ...
    (Zoomify.prototype.addTransition = function (o) {
      this.transition(
        o,
        'all ' + this.options.duration + 'ms ' + this.options.easing,
      );
    }),
    ...
    (Zoomify.prototype.transformScaleAndTranslate = function (o, i, t, n) {
      this.addTransition(this.$image),
        this.transform('scale(' + o + ') translate(' + i + 'px, ' + t + 'px)'),
        this.removeTransition(this.$image, n);
    }),
    ...
    (Zoomify.prototype.zoomIn = function () {
      ...
      this.transform(i),
        ...
        setTimeout(function () {
          o.addShadow(),
            o.transformScaleAndTranslate(f, u, c, function () {
    ...
    (Zoomify.prototype.zoomOut = function () {
      ...
      (this._zooming = !0),
        ...
        this.transformScaleAndTranslate(1, 0, 0, function () {
          (o._zooming = !1),
            o.$image.removeClass('zoomed').trigger('zoom-out-complete.zoomify');
        }),
        this.removeShadow(),
        (this._zoomed = !1);
    }),
    ...
    (Zoomify.prototype.addShadow = function () {
      var o = this;
      this._zoomed ||
        (o.$shadow && o.$shadow.remove(),
        (this.$shadow = z('<div class="zoomify-shadow"></div>')),
        z('body').append(this.$shadow),
    ...
    (z.fn.zoomify = function (t) {
      return this.each(function () {
        var o = z(this),
          i = o.data('zoomify');
        i ||
          o.data('zoomify', (i = new Zoomify(this, 'object' == typeof t && t))),
          'string' == typeof t &&
            0 <= ['zoom', 'zoomIn', 'zoomOut', 'reposition'].indexOf(t) &&
            i[t]();
      });
    });
})(jQuery);
